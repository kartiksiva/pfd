...
def build_media_understanding_payload(evidence: Dict, input_manifest: Optional[Dict] = None) -> Dict:
    ...
    structured_extraction_error = evidence.get("structured_extraction_error")
    structured_extraction_raw_preview = evidence.get("structured_extraction_raw_preview")
    ...
    return {
        ...
        "structured_extraction_raw_preview": structured_extraction_raw_preview,
